...
internal static class NatsJSConstants
{
    ...
    public static readonly ReadOnlySequence<byte> AckProgress =
        new(Encoding.ASCII.GetBytes("+WPI"));
    public static readonly ReadOnlySequence<byte> AckTerminate =
        new(Encoding.ASCII.GetBytes("+TERM"));
}
