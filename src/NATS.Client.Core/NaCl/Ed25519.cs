...
using System;
using NATS.Client.Core.NaCl.Internal.Ed25519Ref10;
...
namespace NATS.Client.Core.NaCl
{
    internal static class Ed25519
    {
        ...
        )
        {
            ...
            if (
                signature.Array == null || message.Array == null || expandedPrivateKey.Array == null
            )
        ...
        /// <param name="privateKeySeed">Private key seed value</param>
        public static void KeyPairFromSeed(
            out byte[] publicKey,
            out byte[] expandedPrivateKey,
            byte[] privateKeySeed
        )
        {
            // Contract.Requires<ArgumentNullException>(privateKeySeed != null);
        ...
        )
        {
            ...
            if (
                expandedPrivateKey.Count != ExpandedPrivateKeySize
