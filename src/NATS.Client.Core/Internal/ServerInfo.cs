...
internal sealed record ServerInfo : INatsServerInfo
{
    ...
    [JsonPropertyName("proto")] public long ProtocolVersion { get; set; }

    [JsonPropertyName("git_commit")] public string GitCommit { get; set; } = string.Empty;
    ...
    [JsonPropertyName("headers")] public bool HeadersSupported { get; set; }
    ...
    [JsonPropertyName("jetstream")] public bool JetStreamAvailable { get; set; }

    [JsonPropertyName("client_id")] public ulong ClientId { get; set; }
    ...
    [JsonPropertyName("cluster_dynamic")] public bool ClusterDynamic { get; set; }

    [JsonPropertyName("connect_urls")] public string[]? ClientConnectUrls { get; set; }

    [JsonPropertyName("ws_connect_urls")] public string[]? WebSocketConnectUrls { get; set; }
